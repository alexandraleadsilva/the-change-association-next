...
const checkItems = [
  ...
  { key: "recognition", label: "There is a deliberate recognition program that specifically names and celebrates the new behaviours" },
