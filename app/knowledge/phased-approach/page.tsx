...
const phases = [
  {
    ...
    what: "The foundation phase is where most change programs rush and most successful ones invest. It covers the diagnostic work, leadership alignment, narrative design, and success definition that everything else builds on. Nothing visible happens to the wider organisation yet, but the conditions for success are being established.",
    activities: [
      ...
      { text: "Define success in terms of outcomes, behaviours, evidence, and timeline", detail: "This is the contract between the program and the business. What will be different, how will we know, and when should we expect to see it? If this is not defined before delivery begins, there is no basis for knowing whether the change is working." },
    ] as ActionItem[],
  ...
  },
  {
    ...
    commonMistake: "Rolling out too fast because the program timeline demands it. Speed without readiness produces compliance at best and chaos at worst. Each wave needs enough time for people to adapt before the next one begins.",
  },
  {
    id: "stabilise",
    num: "04",
    ...
    what: "The stabilisation phase is where most programs hand over to business as usual and walk away. This is exactly where the change is most vulnerable. Stabilisation means staying engaged until the new way of working is genuinely embedded, not just technically live.",
    activities: [
      ...
      { text: "Transfer ownership formally from the program to the business", detail: "Ownership does not transfer by default when the project closes. It transfers when a specific person in the business accepts accountability for sustaining the change, with the resources and authority to do so. If this handover is vague, sustainment will fail." },
    ] as ActionItem[],
