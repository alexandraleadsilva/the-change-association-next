...
const sequencingPrinciples: DetailItem[] = [
  ...
  },
  {
    ...
    content: [
      "In any change program, there is a risk that process change and people change lose synchronisation. Process design accelerates while enablement lags behind. Or people are ready but the new systems are not. This drift is one of the most reliable predictors of change failure.",
...
const caseStudies = [
  ...
  },
  {
    ...
    body: [
      ...
      "The NPfIT was officially dismantled in September 2011. The total cost to taxpayers exceeded 10 billion pounds, with some estimates reaching 12.7 billion. The government acknowledged the program had delivered only around 2.6 billion in actual benefits. An independent review concluded the program had failed because of its top-down approach, its lack of user engagement, and its assumption that people would simply adopt new processes because the technology was available.",
    ],
