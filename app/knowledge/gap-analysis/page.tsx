...
const lenses = [
  {
    ...
    questions: [
      ...
      { text: "Where are the informal influencers, and are they on board?", detail: "Formal authority is not enough. The people who shape how others feel about change often have no formal role in the programme. If the gap between their current stance and active support is wide, the change will struggle regardless of what leadership says." },
    ] as ListItem[],
    methods: [
      ...
      { text: "Stakeholder readiness mapping across levels and functions", detail: "For each key stakeholder group, assess their current awareness, understanding, and willingness to change. Map this against what the programme needs from them. The gaps tell you where to focus engagement effort." },
  ...
  },
  {
    ...
    blindSpots: [
      ...
      { text: "Underestimating the number of processes affected", detail: "Change programmes often scope narrowly. But processes are connected. A change in one area cascades into adjacent processes through handoffs, data flows, and dependencies. A gap analysis that does not follow these connections will undercount the gaps." },
