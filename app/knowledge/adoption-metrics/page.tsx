...
const adoptionStages: AdoptionStage[] = [
  ...
  },
  {
    ...
    metrics: [
      { text: "Role-specific comprehension checks", detail: "Test whether people understand what will change in their specific role, not just the overall programme. A finance analyst and a sales manager experience the same ERP implementation very differently. Measure understanding at the role level." },
...
const caseStudies = [
  {
    ...
    body: [
      ...
      "The contrast with typical enterprise deployments is stark. Across the industry, the average enterprise Copilot adoption rate is just 34% of licensed users at 90 days. Organisations with structured rollout programmes achieve 65 to 78%. Microsoft's approach demonstrates that the difference is not the technology. It is the measurement and response system built around it.",
    ],
