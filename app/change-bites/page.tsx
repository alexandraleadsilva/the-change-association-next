...
const changeBites: ChangeBite[] = [
  ...
  },
  {
    ...
    body: [
      "Every change program has a plan. A Gantt chart with milestones. A communication schedule. A training calendar. A stakeholder matrix. A RAID log. These are the artefacts of change management. They are necessary. They are not sufficient.",
  ...
  },
  {
    ...
    body: [
      ...
      "This matters for change because culture is the environment in which every change initiative either takes root or dies. You can design the perfect change program, but if the culture is working against it, the program will lose.",
  ...
  },
  {
    ...
    body: [
      "There is a pattern that plays out in almost every large transformation. The program team builds the plan. Leadership approves it. And then someone asks: who is going to handle the people side? The answer, almost invariably, is HR.",
      ...
      "HR is expected to manage communications, handle resistance, deliver training, support affected employees, redesign roles, update policies, and maintain engagement, all while continuing their day job. No function can do all of that well. And when they inevitably cannot, they become the scapegoat for the program's failure to manage change properly.",
      "The real question is not whether HR should be involved. Of course they should. The question is what HR should own versus what the program should own versus what line managers should own. Without that clarity, everyone assumes someone else is doing it, and the critical work falls through the gaps.",
    ...
    takeaway: "HR should enable the people systems that sustain change. They should not be the default owner of everything the program team does not want to do.",
    relatedLabel: "Go deeper on this topic",
  ...
  },
  {
    ...
    body: [
      ...
      "Adoption is a behaviour, not an event. It is not measured by whether someone attended the training. It is measured by whether they changed how they work. And the distance between attending and adopting is where most enablement programs fail.",
  ...
  },
  {
    ...
    takeaway: "Information tells people what to do. Experience teaches them what it feels like. You need both, but most change programs only deliver the first.",
    relatedLabel: "Go deeper on this topic",
  ...
  },
  {
    ...
    body: [
      "Ask five people in a transformation program what HR's role is and you will get five different answers. HR supports the people side. HR handles the comms. HR manages the training. HR deals with the restructure. HR looks after the affected employees.",
      "The confusion is not HR's fault. It is a design failure in how organisations set up their change programs. When nobody explicitly defines who owns what, HR becomes the default owner of everything that is not technical delivery. And because HR professionals genuinely care about people, they accept the work even when it is not theirs to carry.",
      ...
      "The fix is role clarity. Before the program starts, define explicitly what HR owns, what the change management function owns, what line managers own, and what the program team owns. Write it down. Test it with each group. And revisit it when the boundaries get blurred, because they will.",
      "HR's most powerful contribution to a transformation is not doing everything. It is owning the systems that sustain change: performance management, reward and recognition, capability development, and workforce planning. These are the levers that determine whether the change sticks after the program team leaves.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Culture change is slow, it is hard, and it cannot be delegated to a program team. It requires leaders to change their own behaviour first, then to redesign the systems that shape everyone else's behaviour. There are no shortcuts.",
    ],
